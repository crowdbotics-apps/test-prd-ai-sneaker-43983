...
## Project Structure
    ...
    ├── test_prd_ai_sneaker_43983  # Django project configurations
...
1. Clone this repo and `cd test_prd_ai_sneaker_43983`
...
2. Clone this repo and `cd test_prd_ai_sneaker_43983`
